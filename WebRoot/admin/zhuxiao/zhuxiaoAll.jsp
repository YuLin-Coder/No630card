...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
       ...
       <script language="javascript">
           function zhuxiaoByAdmin(zhuxiaoId)
           {
               if(confirm('您确定注销吗？'))
               {
                   window.location.href="<%=path %>/zhuxiaoByAdmin.action?zhuxiaoId="+zhuxiaoId;
               }
           }
		...
		<div class="body-box">
			...
			<table class="pn-ltable" width="100%" cellspacing="1" cellpadding="0" border="0">
				...
				<tbody class="pn-ltbody">
					<s:iterator value="#request.zhuxiaoList" id="zhuxiao">
					<tr onmouseover="Pn.LTable.lineOver(this);" onmouseout="Pn.LTable.lineOut(this);" onclick="Pn.LTable.lineSelect(this);">
						<%--<td align="center">
							<input type="checkbox" name="ids" value="1" />
						</td>--%>
						<td align="center">
							<s:property value="#zhuxiao.userId"/>
						</td>
						<td align="center">
							<s:property value="#zhuxiao.zhuxiaoShijian"/>
						</td>
						<td class="pn-lopt">
							<a href="#" onclick="zhuxiaoByAdmin(<s:property value="#zhuxiao.zhuxiaoId"/>)" class="pn-loperator">注销</a>
						</td>
					</tr>
					</s:iterator>
				</tbody>
