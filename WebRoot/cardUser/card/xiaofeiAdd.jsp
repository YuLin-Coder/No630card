...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
           function check()
           {
               if(document.formPw.xiaofeiJine.value=="")
               {
                   alert("消费金额不能空");
                   return false;
               }
		...
		<div class="body-box">
			...
			<table width="100%" class="pn-ftable" cellpadding="2" cellspacing="1" border="0">
				...
				<tr>
				    ...
				    <td width="80%" class="pn-fcontent">
				        <input type="text" name="xiaofeiJine" id="xiaofeiJine" size="22" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
				    </td>
				</tr>
				<tr>
				    <td width="20%" class="pn-flabel pn-flabel-h">
				...
				<tr>
				    ...
				    <td width="80%" class="pn-fcontent">
				        <textarea rows="7" cols="50" name="xiaofeiBeizhu"></textarea>
				    </td>
				</tr>
				<tr>
				    <td width="20%" class="pn-flabel pn-flabel-h">
